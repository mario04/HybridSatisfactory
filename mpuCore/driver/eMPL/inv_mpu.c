...
#include "../../Peripheral/inc/i2c.h"
#include "../../User/inc/main.h"
#include "../include/log.h"
   
#define i2c_write   I2C_WriteRegister
#define i2c_read    I2C_ReadRegister
#define delay_ms    HAL_Delay // TODO make non-blocking osDelay (is only used during initialisation though, so no big problem )
#define get_ms      mpu_get_tick_count
#define log_i       uartWriteLineNoOS
#define log_e       uartWriteLineNoOS
